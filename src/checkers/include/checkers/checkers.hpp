...
#include "dakrnet_emulator_msgs/msg/bounding_box.hpp"
...
class Checkers : public rclcpp::Node {
	...
	private:
		rclcpp::Publisher<std_msgs::msg::String>::SharedPtr commandPublisher_;t
		rclcpp::Subscription<darknet_emulator_msgs::msg::BoundingBoxes>::SharedPtr boudningBoxesSubscriber_;
		size_t count_;
